...
public class SimpleAi extends AI implements Runnable {
     ...
     * DEAD 表示两边被堵住
     */
    private final static int FIVE = 10000;      //连五
    private final static int LIVE_FOUR = 4500;  //活四，已成定局，无法防守
    private final static int DEAD_FOUR = 2000;  //死四，已经有了四个但是一端被堵住
    private final static int LIVE_THREE = 900;  //活三，没有被堵住的连成线的三个子
    private final static int DEAD_THREE = 400;  //依次类推。。。
    ...
    public SimpleAi(int[][] chessArray, AICallBack callBack) {
